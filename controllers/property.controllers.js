...
//   const properties = await Property.find();
//   if (!properties) {
//       return next(new ErrorHandler("Properties not found", 400))
//   }

//   if (!filter && !value) {
//       res
//           .status(200)
//           .json({ message: "properties achieved", success: true, properties });
//   }

//   if (filter && value) {
//       properties.filter((properties) => properties[filter].includes(value));
